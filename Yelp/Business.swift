...
class Business: NSObject {
    ...
    class func searchWithParameters(searchParameters: [String: AnyObject], term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: ([Business]!, NSError!) -> Void) -> Void {
        YelpClient.sharedInstance.searchWithParameters(searchParameters, term: term, sort: sort, categories: categories, deals: deals, completion: completion)
    }
}
